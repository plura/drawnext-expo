...
import AppLogoBrand from "@/assets/app_logo_brand.svg";
import AppLogoDev from "@/assets/app_logo_dev.svg";
    ...
    <div className={`shrink-0 ${pad}`} role="presentation" aria-hidden="true">
      <div className={`flex ${dir} items-center justify-between`}>
        ...
        <div className={`flex ${row ? "flex-row" : "flex-col"} items-center gap-10`}>
          <img src={AppLogoBrand} alt="App Logo" className="h-4 w-auto" />
          <img src={AppLogoDev} alt="Developer Logo" className="h-4 w-auto" />
