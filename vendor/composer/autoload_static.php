...
class ComposerStaticInite875ae8441d070d7dda5f4b47a2117aa
{
    ...
    public static $classMap = array (
        ...
        'Lib\\ApiResponse' => __DIR__ . '/../..' . '/backend/lib/ApiResponse.php',
        'Lib\\Auth' => __DIR__ . '/../..' . '/backend/lib/Auth.php',
        'Lib\\Config' => __DIR__ . '/../..' . '/backend/lib/Config.php',
        'Lib\\Database' => __DIR__ . '/../..' . '/backend/lib/Database.php',
        'Lib\\Drawing' => __DIR__ . '/../..' . '/backend/lib/Drawing.php',
        'Lib\\Env' => __DIR__ . '/../..' . '/backend/lib/Env.php',
        'Lib\\FileHandler' => __DIR__ . '/../..' . '/backend/lib/FileHandler.php',
        'Lib\\FileHandlerException' => __DIR__ . '/../..' . '/backend/lib/FileHandlerException.php',
        'Lib\\FileServer' => __DIR__ . '/../..' . '/backend/lib/FileServer.php',
        'Lib\\Notebook' => __DIR__ . '/../..' . '/backend/lib/Notebook.php',
        'Lib\\Storage' => __DIR__ . '/../..' . '/backend/lib/Storage.php',
        'Lib\\User' => __DIR__ . '/../..' . '/backend/lib/User.php',
        'Lib\\Validation' => __DIR__ . '/../..' . '/backend/lib/Validation.php',
